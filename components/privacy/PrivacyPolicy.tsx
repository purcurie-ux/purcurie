        ...
        <div className="w-layout-blockcontainer container w-container">
          <div className="info-outer">
            ...
            <div className="info-data">
              ...
              <div className="data-wrap">
                <p>
                  We collect personal information that you voluntarily provide when you register on the Platform, place an order, contact customer support, participate in promotions or otherwise interact with us. This information may include your name, email address, phone number, billing and shipping address, payment related information and any preferences or skin-related data that you choose to share.
                </p>
                <p>
                  We also automatically collect certain information when you use our Platform, including your IP address, device type, browser type, approximate location, pages visited, time spent on the Platform and data collected through cookies and similar technologies. We may further receive information about you from third-party service providers such as payment gateways, delivery partners, analytics platforms and marketing partners.
                </p>
              </div>
            </div>
